...
Welcome to `aegisx` 👋 We value small, high-quality, verifiable contributions.
...
| You want to...                    | Use...                                                                   |
| --------------------------------- | ------------------------------------------------------------------------ |
| Ask a question / propose a design | 💬 [Discussions](https://github.com/comstrx/aegisx/discussions)          |
| Report a reproducible bug         | 🐞 [Issues](https://github.com/comstrx/aegisx/issues)                    |
| Report a security issue (private) | 🔒 [Security](https://github.com/comstrx/aegisx/security/advisories/new) |

[Repository](https://github.com/comstrx/aegisx)
...
If you are unsure about scope, start with a short [Discussion](https://github.com/comstrx/aegisx/discussions).
...
3. Read the current [README](https://github.com/comstrx/aegisx/blob/main/README.md) and repository validation rules.
...
By participating, you agree to follow the [Code of Conduct](https://github.com/comstrx/aegisx/blob/main/CODE_OF_CONDUCT.md).

## Security

Do not disclose security issues publicly. [Report them privately](https://github.com/comstrx/aegisx/security/advisories/new).
